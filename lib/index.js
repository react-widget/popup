...
function (_React$Component) {
  ...
  function Popup() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "_hasSetPosition", false);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "refPopup", function (el) {
      _this._popupRef = el;
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "refPopupMask", function (el) {
  ...
  (0, _createClass2.default)(Popup, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_TransitionGroupContext.default.Provider, {
        value: null
      }, _react.default.createElement(RootComponent, null, this.renderPopupMask(), _react.default.createElement(Transition, {
        timeout: timeout,
        ...
        exit: true,
        appear: true
      }, _react.default.createElement(PopupComponent, (0, _extends2.default)({}, (0, _omit.default)(others, Object.keys(propTypes)), {
        ref: this.refPopup,
        className: cls
      }), children))));
    }
...
Object.assign(Popup.prototype, _CSSTransition.default);
var _default = Popup;
